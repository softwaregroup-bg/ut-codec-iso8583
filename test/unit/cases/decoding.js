...
tap.test('decode correct buffer to message object', (t) => {
    ...
    let context = {};
    let log = {};
    let objDecode = iso8583.decode(Buffer.from(buff.buffCorrect, 'hex'), meta, context, log);
...
tap.test('decode buffer with wrong frame', (t) => {
    ...
    let context = {};
    let log = {};
    let objDecode = iso8583.decode(Buffer.from(buff.buffWrongFrame, 'hex'), meta, context, log);
...
tap.test('decode buffer with extra bytes', (t) => {
    ...
    let context = {};
    let log = {};
    let objDecode = iso8583.decode(Buffer.from(buff.buffExtralong, 'hex'), meta, context, log);
    t.match(objDecode, obj.messageParserError, 'test message object');
    t.match(meta, obj.metaError, 'test meta object');
    t.end();
});
tap.test('decode buffer with wrong field', (t) => {
    ...
    let context = {};
    let log = {};
    let objDecode = iso8583.decode(Buffer.from(buff.buffWrongField, 'ascii'), meta, context, log);
    t.match(objDecode, obj.messageParserError, 'test message object');
    t.match(meta, obj.metaError, 'test meta object');
    t.end();
});
tap.test('decode buffer ISO field 39 error', (t) => {
    ...
    let context = {};
    let log = {};
    let objDecode = iso8583.decode(Buffer.from(buff.buffISOError, 'hex'), meta, context, log);
...
tap.test('decode buffer with MTI 0800', (t) => {
    ...
    let context = {};
    let log = {};
    let objDecode = iso8583.decode(Buffer.from(buff.buffMTI0800, 'hex'), meta, context, log);
